                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                                """1.Yield Stress = Load at yield Point/Original C/s Area"""),
                            SizedBox(
                              height: 10,
                            ),
                            Text(
                                """2.Ultimate Stress = Ultimate Load/Original C/s Area"""),
                            SizedBox(
                              height: 10,
                            ),
                            Text(
                                """3.Nominal Breaking Stress = Breaking Load/Nominal Breaking Stress"""),
                            SizedBox(
                              height: 10,
                            ),
                            Text(
                            ...
                            Text(
                                """5.Percentage elongation = (Change in length/Original Length)/100"""),
                            SizedBox(
                              height: 10,
                            ),
                            Text(
                                """6.Percentage reduction in the area = (Change in length/Original Area)/100"""),
                          ],
                        ),
                      ),
                    ],
