                  ...
                  child: ExpansionTile(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Text(
                            """Water absorption test on blocks are conducted to determine durability property of blocks such as degree of burning, quality and behavior of bricks in weathering. A block with water absorption of less than 7% provides better resistance to damage by freezing. The degree of compactness of bricks can be obtained by water absorption test, as water is absorbed by pores in bricks. The water absorption by blocks increase with increase in pores. So, the blocks, which have water absorption less than 3 percent can be called as vitrified. This test provides  the percentage of water absorption of blocks and procedure of the same is discussed below."""),
                      ),
                    ],
                  ),
                ),
